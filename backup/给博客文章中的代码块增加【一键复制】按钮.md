...
document.addEventListener("DOMContentLoaded", function() {
    ...
    clipboardScript.src = 'https://linji1.github.io/assets/file/2025/02/clipboard.min.js';
...
全局
```
"script":"<script src='https://linji1.github.io/assets/file/2025/02/copy.js'></script>",
```
单个
...
<!-- ##{"script":"<script src='https://linji1.github.io/assets/file/2025/02/copy.js'></script>"}## -->
```
文章来源：https://blog.liyifan.xyz/post/gei-bo-ke-wen-zhang-zhong-de-dai-ma-kuai-zeng-jia-%E3%80%90-yi-jian-fu-zhi-%E3%80%91-an-niu.html