...
![创建仓库](https://linji1.github.io/assets/file/2025/02/e860fa26fc02859344a77.webp)

会打开如下网页：

![](https://linji1.github.io/assets/file/2025/02/c4fc9e5406082ab8eaf02.webp)
...
![](https://linji1.github.io/assets/file/2025/02/e7a2658c391bb245ff30f.webp)

## 二、配置仓库

### 1. 进入刚刚创建完成的仓库，点击`settings`

![](https://linji1.github.io/assets/file/2025/02/edc56fb31b0510b441497.webp)

### 2. 进入`pages`分页

![](https://linji1.github.io/assets/file/2025/02/89198898a426807f1ed19.webp)

### 3. 将构建方式改为`github actions`

![](https://linji1.github.io/assets/file/2025/02/5adfdac21ba9da137f6e4.webp)

> [!NOTE]
> 关于自定义域名，可以在下方的`custom domain`中填写，需要一个二级域名，并添加cname解析，指向`github账号的名字.github.io`

![](https://linji1.github.io/assets/file/2025/02/8f04f09bdcdf8fd81cd6f.webp)

![](https://linji1.github.io/assets/file/2025/02/98294a9f9b913b9caf96b.webp)


### 4. 进入`issues`页面，然后点击`new issue`

![](https://linji1.github.io/assets/file/2025/02/087b466ec09136a170fa9.webp)

### 5. 随意填入标题和正文，随意添加一个`标签（lable）`，然后点击`submit new issue`

![](https://linji1.github.io/assets/file/2025/02/7bc0d98eed8e4fe84484c.webp)

此时在`actions`界面中可以看到正在构建，等待一分钟左右直到构建完成

### 6. 回到`code`界面，此时域名已经生成

![](https://linji1.github.io/assets/file/2025/02/68b636609b57df758edc2.webp)
...
![](https://linji1.github.io/assets/file/2025/02/4dcf3ca2c7fbc0f740eba.webp)

点击钢笔图案开始编辑

![](https://linji1.github.io/assets/file/2025/02/ca56f9adf974763b3d6ae.webp)
...
![](https://linji1.github.io/assets/file/2025/02/6fc709491a266dee0d820.webp)
