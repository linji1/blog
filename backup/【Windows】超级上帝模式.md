...
![](https://linji1.github.io/assets/file/2025/02/12-1.webp)

该脚本的主要功能是收集并为系统各种选项、部分应用程序和深层链接创建快捷方式，这些快捷方式会被自动分类，例如属于系统配置类的全部放在任务列表里。

![](https://linji1.github.io/assets/file/2025/02/12-2.webp)

而深层链接指的是那些需要调用设置应用的选项，是的没错，连设置应用里的选项也可以做成快捷方式快速打开。

![](https://linji1.github.io/assets/file/2025/02/12-3.webp)
